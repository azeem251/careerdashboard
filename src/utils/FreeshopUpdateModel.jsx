...
const FreeUpdateModel = ({ onUpdateClose, updateId, updateData, getArticleAPI }) => {
...
const handleUpdateSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://mamun-reza-freeshops-backend.vercel.app/api/v1/admin/FreeShopNews/updateFreeShopNews/${updateId}`,
        formData
      );
  
      await getArticleAPI();
      Swal.fire('Updated', 'Freeshop updated successfully!', 'success');
...
export default FreeUpdateModel;
